...
import { EmployeeCreateParams, EmployeeCreateResponse, EmployeeDeleteResponse, EmployeeLinkUserParams, EmployeeLinkUserResponse, EmployeeListParams, EmployeeListResponse, EmployeeRetrieveResponse, EmployeeUnlinkUserParams, EmployeeUnlinkUserResponse, EmployeeUpdateParams, EmployeeUpdateResponse, Employees } from './resources/employees';
import { Fax, FaxListProvidersResponse, FaxRetrieveStatusResponse, FaxSendParams, FaxSendResponse } from './resources/fax';
import { Health, HealthCheckResponse } from './resources/health';
import { Hl7, Hl7SendResultsParams, Hl7SendResultsResponse } from './resources/hl7';
import { IntegrationCheckActiveParams, IntegrationCheckActiveResponse, IntegrationListParams, IntegrationListResponse, Integrations } from './resources/integrations';
import { OrderCreateParams, OrderCreateResponse, OrderRetrieveResponse, OrderRetrieveResultsParams, OrderRetrieveResultsResponse, OrderScheduleAppointmentParams, OrderScheduleAppointmentResponse, OrderSendForEmployeeParams, OrderSendForEmployeeResponse, OrderUpdateParams, OrderUpdateResponse, OrderUpdateStatusParams, OrderUpdateStatusResponse, OrderUploadResultsParams, OrderUploadResultsResponse, Orders } from './resources/orders';
...
import { EmployerCreateParams, EmployerCreateResponse, EmployerListParams, EmployerListResponse, EmployerRetrieveResponse, Employers } from './resources/employers/employers';
...
export class BlueHive {
   ...
   */
  constructor({
    baseURL = readEnv('BLUE_HIVE_BASE_URL'),
    apiKey = readEnv('BLUEHIVE_API_KEY'),
    ...opts
  }: ClientOptions = {}) {
    if (apiKey === undefined) {
      throw new Errors.BlueHiveError(
        'The BLUEHIVE_API_KEY environment variable is missing or empty; either provide it, or instantiate the BlueHive client with an apiKey option, like new BlueHive({ apiKey: \'My API Key\' }).'
      );
    }
    ...
    this.timeout = options.timeout ?? BlueHive.DEFAULT_TIMEOUT /* 1 minute */;
    this.logger = options.logger ?? console;
    const defaultLogLevel = 'warn';
    // Set default logLevel early so that we can log a warning in parseLogLevel.
    this.logLevel = defaultLogLevel;
    this.logLevel = parseLogLevel(options.logLevel, 'ClientOptions.logLevel', this) ?? parseLogLevel(readEnv('BLUE_HIVE_LOG'), 'process.env[\'BLUE_HIVE_LOG\']', this) ?? defaultLogLevel;
  ...
  static BlueHive = this;
  static DEFAULT_TIMEOUT = 60000 // 1 minute

  static BlueHiveError = Errors.BlueHiveError;
