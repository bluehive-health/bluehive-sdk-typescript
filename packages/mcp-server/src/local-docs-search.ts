...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      "{ _id: string; address: object; email: string; name: string; phones: object[]; createdAt?: string; createdBy?: string; demo?: boolean; employeeConsent?: boolean; onsiteClinic?: boolean; status?: 'active' | 'waitlisted'; website?: string; }",
    markdown:
  ...
  },
  {
    ...
    params: [
      "{ paymentMethod: 'self-pay' | 'employer-sponsored'; person: { city: string; dob: string; email: string; firstName: string; lastName: string; phone: string; state: string; street: string; zipcode: string; country?: string; county?: string; street2?: string; }; providerId: string; services: { _id: string; quantity: number; autoAccept?: boolean; }[]; _id?: string; brandId?: string; bundleIds?: object; dueDate?: string; dueDates?: string[]; employeeId?: string; employeeIds?: string[]; employerId?: string; metadata?: object; priority?: 'normal' | 'high'; providerCreated?: boolean; providersIds?: { providerId: string; serviceId?: string; }[]; quantities?: object; reCaptchaToken?: string; servicesIds?: string[]; tokenId?: string; } | { employeeId: string; employerId: string; services: { _id: string; quantity: number; autoAccept?: boolean; }[]; _id?: string; brandId?: string; bundleIds?: object; dueDate?: string; dueDates?: string[]; employeeIds?: string[]; metadata?: object; paymentMethod?: 'self-pay' | 'employer-sponsored'; person?: { city: string; dob: string; email: string; firstName: string; lastName: string; phone: string; state: string; street: string; zipcode: string; country?: string; county?: string; street2?: string; }; priority?: 'normal' | 'high'; providerCreated?: boolean; providerId?: string; providersIds?: { providerId: string; serviceId?: string; }[]; quantities?: object; reCaptchaToken?: string; servicesIds?: string[]; tokenId?: string; } | { employeeId: string; employerId: string; providersIds: { providerId: string; serviceId?: string; }[]; servicesIds: string[]; _id?: string; brandId?: string; bundleIds?: object; dueDate?: string; dueDates?: string[]; employeeIds?: string[]; metadata?: object; paymentMethod?: 'self-pay' | 'employer-sponsored'; person?: { city: string; dob: string; email: string; firstName: string; lastName: string; phone: string; state: string; street: string; zipcode: string; country?: string; county?: string; street2?: string; }; priority?: 'normal' | 'high'; providerCreated?: boolean; providerId?: string; quantities?: object; reCaptchaToken?: string; services?: { _id: string; quantity: number; autoAccept?: boolean; }[]; tokenId?: string; } | { employeeIds: string[]; employerId: string; providersIds: { providerId: string; serviceId?: string; }[]; servicesIds: string[]; _id?: string; brandId?: string; bundleIds?: object; dueDate?: string; dueDates?: string[]; employeeId?: string; metadata?: object; paymentMethod?: 'self-pay' | 'employer-sponsored'; person?: { city: string; dob: string; email: string; firstName: string; lastName: string; phone: string; state: string; street: string; zipcode: string; country?: string; county?: string; street2?: string; }; priority?: 'normal' | 'high'; providerCreated?: boolean; providerId?: string; quantities?: object; reCaptchaToken?: string; services?: { _id: string; quantity: number; autoAccept?: boolean; }[]; tokenId?: string; };",
    ],
    response:
    ...
    markdown:
      "## create\n\n`client.orders.create(body?: { paymentMethod: 'self-pay' | 'employer-sponsored'; person: { city: string; dob: string; email: string; firstName: string; lastName: string; phone: string; state: string; street: string; zipcode: string; country?: string; county?: string; street2?: string; }; providerId: string; services: { _id: string; quantity: number; autoAccept?: boolean; }[]; _id?: string; brandId?: string; bundleIds?: object; dueDate?: string; dueDates?: string[]; employeeId?: string; employeeIds?: string[]; employerId?: string; metadata?: object; priority?: 'normal' | 'high'; providerCreated?: boolean; providersIds?: { providerId: string; serviceId?: string; }[]; quantities?: object; reCaptchaToken?: string; servicesIds?: string[]; tokenId?: string; } | { employeeId: string; employerId: string; services: { _id: string; quantity: number; autoAccept?: boolean; }[]; _id?: string; brandId?: string; bundleIds?: object; dueDate?: string; dueDates?: string[]; employeeIds?: string[]; metadata?: object; paymentMethod?: 'self-pay' | 'employer-sponsored'; person?: { city: string; dob: string; email: string; firstName: string; lastName: string; phone: string; state: string; street: string; zipcode: string; country?: string; county?: string; street2?: string; }; priority?: 'normal' | 'high'; providerCreated?: boolean; providerId?: string; providersIds?: { providerId: string; serviceId?: string; }[]; quantities?: object; reCaptchaToken?: string; servicesIds?: string[]; tokenId?: string; } | { employeeId: string; employerId: string; providersIds: { providerId: string; serviceId?: string; }[]; servicesIds: string[]; _id?: string; brandId?: string; bundleIds?: object; dueDate?: string; dueDates?: string[]; employeeIds?: string[]; metadata?: object; paymentMethod?: 'self-pay' | 'employer-sponsored'; person?: { city: string; dob: string; email: string; firstName: string; lastName: string; phone: string; state: string; street: string; zipcode: string; country?: string; county?: string; street2?: string; }; priority?: 'normal' | 'high'; providerCreated?: boolean; providerId?: string; quantities?: object; reCaptchaToken?: string; services?: { _id: string; quantity: number; autoAccept?: boolean; }[]; tokenId?: string; } | { employeeIds: string[]; employerId: string; providersIds: { providerId: string; serviceId?: string; }[]; servicesIds: string[]; _id?: string; brandId?: string; bundleIds?: object; dueDate?: string; dueDates?: string[]; employeeId?: string; metadata?: object; paymentMethod?: 'self-pay' | 'employer-sponsored'; person?: { city: string; dob: string; email: string; firstName: string; lastName: string; phone: string; state: string; street: string; zipcode: string; country?: string; county?: string; street2?: string; }; priority?: 'normal' | 'high'; providerCreated?: boolean; providerId?: string; quantities?: object; reCaptchaToken?: string; services?: { _id: string; quantity: number; autoAccept?: boolean; }[]; tokenId?: string; }): { orderId: string; orderNumber: string; success: true; hostedInvoiceUrl?: string; message?: string; partialSuccess?: boolean; selfPay?: boolean; unavailableServices?: object[]; } | { orderResults: object[]; status: 'split'; success: true; message?: string; partialSuccess?: boolean; unavailableServices?: object[]; }`\n\n**post** `/v1/orders`\n\nCreate orders for consumers (self-pay or employer-sponsored), employers, or bulk orders. Consolidates functionality from legacy Order.createOrder and Order.SendOrder methods.\n\n### Parameters\n\n- `body?: { paymentMethod: 'self-pay' | 'employer-sponsored'; person: { city: string; dob: string; email: string; firstName: string; lastName: string; phone: string; state: string; street: string; zipcode: string; country?: string; county?: string; street2?: string; }; providerId: string; services: { _id: string; quantity: number; autoAccept?: boolean; }[]; _id?: string; brandId?: string; bundleIds?: object; dueDate?: string; dueDates?: string[]; employeeId?: string; employeeIds?: string[]; employerId?: string; metadata?: object; priority?: 'normal' | 'high'; providerCreated?: boolean; providersIds?: { providerId: string; serviceId?: string; }[]; quantities?: object; reCaptchaToken?: string; servicesIds?: string[]; tokenId?: string; } | { employeeId: string; employerId: string; services: { _id: string; quantity: number; autoAccept?: boolean; }[]; _id?: string; brandId?: string; bundleIds?: object; dueDate?: string; dueDates?: string[]; employeeIds?: string[]; metadata?: object; paymentMethod?: 'self-pay' | 'employer-sponsored'; person?: { city: string; dob: string; email: string; firstName: string; lastName: string; phone: string; state: string; street: string; zipcode: string; country?: string; county?: string; street2?: string; }; priority?: 'normal' | 'high'; providerCreated?: boolean; providerId?: string; providersIds?: { providerId: string; serviceId?: string; }[]; quantities?: object; reCaptchaToken?: string; servicesIds?: string[]; tokenId?: string; } | { employeeId: string; employerId: string; providersIds: { providerId: string; serviceId?: string; }[]; servicesIds: string[]; _id?: string; brandId?: string; bundleIds?: object; dueDate?: string; dueDates?: string[]; employeeIds?: string[]; metadata?: object; paymentMethod?: 'self-pay' | 'employer-sponsored'; person?: { city: string; dob: string; email: string; firstName: string; lastName: string; phone: string; state: string; street: string; zipcode: string; country?: string; county?: string; street2?: string; }; priority?: 'normal' | 'high'; providerCreated?: boolean; providerId?: string; quantities?: object; reCaptchaToken?: string; services?: { _id: string; quantity: number; autoAccept?: boolean; }[]; tokenId?: string; } | { employeeIds: string[]; employerId: string; providersIds: { providerId: string; serviceId?: string; }[]; servicesIds: string[]; _id?: string; brandId?: string; bundleIds?: object; dueDate?: string; dueDates?: string[]; employeeId?: string; metadata?: object; paymentMethod?: 'self-pay' | 'employer-sponsored'; person?: { city: string; dob: string; email: string; firstName: string; lastName: string; phone: string; state: string; street: string; zipcode: string; country?: string; county?: string; street2?: string; }; priority?: 'normal' | 'high'; providerCreated?: boolean; providerId?: string; quantities?: object; reCaptchaToken?: string; services?: { _id: string; quantity: number; autoAccept?: boolean; }[]; tokenId?: string; }`\n\n### Returns\n\n- `{ orderId: string; orderNumber: string; success: true; hostedInvoiceUrl?: string; message?: string; partialSuccess?: boolean; selfPay?: boolean; unavailableServices?: { reason: string; serviceId: string; serviceName?: string; }[]; } | { orderResults: { orderId: string; orderNumber: string; providerId: string; }[]; status: 'split'; success: true; message?: string; partialSuccess?: boolean; unavailableServices?: { reason: string; serviceId: string; serviceName?: string; }[]; }`\n\n### Example\n\n```typescript\nimport BlueHive from '@bluehive/sdk';\n\nconst client = new BlueHive();\n\nconst order = await client.orders.create();\n\nconsole.log(order);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: [
      ...
      'metadata?: object;',
      "services?: { serviceId: string; dueDate?: string; expirationDate?: string; results?: object; status?: 'pending' | 'in_progress' | 'completed' | 'cancelled' | 'rejected'; }[];",
      'status?: string;',
    ],
    response:
      '{ message: string; orderId: string; orderNumber: string; success: true; updatedFields?: string[]; }',
    markdown:
      "## update\n\n`client.orders.update(orderId: string, expirationDate?: string, metadata?: object, services?: { serviceId: string; dueDate?: string; expirationDate?: string; results?: object; status?: 'pending' | 'in_progress' | 'completed' | 'cancelled' | 'rejected'; }[], status?: string): { message: string; orderId: string; orderNumber: string; success: true; updatedFields?: string[]; }`\n\n**post** `/v1/orders/{orderId}`\n\nUpdate order details and associated order items. Allows updating order status, metadata, and modifying order item services.\n\n### Parameters\n\n- `orderId: string`\n\n- `expirationDate?: string`\n  Order expiration date (ISO 8601 format). Set to null to remove the expiration date.\n\n- `metadata?: object`\n  Arbitrary metadata to update on the order (non-indexed passthrough, <=10KB when JSON stringified)\n\n- `services?: { serviceId: string; dueDate?: string; expirationDate?: string; results?: object; status?: 'pending' | 'in_progress' | 'completed' | 'cancelled' | 'rejected'; }[]`\n\n- `status?: string`\n\n### Returns\n\n- `{ message: string; orderId: string; orderNumber: string; success: true; updatedFields?: string[]; }`\n\n  - `message: string`\n  - `orderId: string`\n  - `orderNumber: string`\n  - `success: true`\n  - `updatedFields?: string[]`\n\n### Example\n\n```typescript\nimport BlueHive from '@bluehive/sdk';\n\nconst client = new BlueHive();\n\nconst order = await client.orders.update('orderId');\n\nconsole.log(order);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    description:
      'Upload test results for a specific order item. Supports both existing fileIds and base64 encoded files. Public SPA requests require an order access code and CAPTCHA. Delegated requests require an internal API key and x-provider-spa-session, send base64 file contents, and the API stores them in BlueHive file storage.',
    ...
    response: '{ fileIds?: string[]; message?: string; success?: boolean; }',
    markdown:
      "## upload_results\n\n`client.orders.uploadResults(orderId: string, orderAccessCode: string, serviceId: string, captchaToken?: string, dob?: string, fileIds?: string[], files?: { base64: string; name: string; type: string; }[], lastName?: string): { fileIds?: string[]; message?: string; success?: boolean; }`\n\n**post** `/v1/orders/{orderId}/upload-results`\n\nUpload test results for a specific order item. Supports both existing fileIds and base64 encoded files. Public SPA requests require an order access code and CAPTCHA. Delegated requests require an internal API key and x-provider-spa-session, send base64 file contents, and the API stores them in BlueHive file storage.\n\n### Parameters\n\n- `orderId: string`\n\n- `orderAccessCode: string`\n\n- `serviceId: string`\n\n- `captchaToken?: string`\n\n- `dob?: string`\n  Date of birth in YYYY-MM-DD format\n\n- `fileIds?: string[]`\n\n- `files?: { base64: string; name: string; type: string; }[]`\n\n- `lastName?: string`\n\n### Returns\n\n- `{ fileIds?: string[]; message?: string; success?: boolean; }`\n\n  - `fileIds?: string[]`\n  - `message?: string`\n  - `success?: boolean`\n\n### Example\n\n```typescript\nimport BlueHive from '@bluehive/sdk';\n\nconst client = new BlueHive();\n\nconst response = await client.orders.uploadResults('orderId', { orderAccessCode: 'x', serviceId: 'x' });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
      ...
      ruby: {
        method: 'orders.upload_results',
        example:
          'require "blue_hive"\n\nblue_hive = BlueHive::Client.new(api_key: "My API Key")\n\nresponse = blue_hive.orders.upload_results("orderId", order_access_code: "x", service_id: "x")\n\nputs(response)',
      },
      http: {
        example:
