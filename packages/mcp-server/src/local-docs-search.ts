...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    "response": "{ count: number; providers: { address_1: string; address_2: string; city: string; country: string; distance: number; fax_number: string; firstname: string; lastname: string; npi: string; postal_code: string; state_province: string; work_phone: string; }[]; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bluehive.com/v1/providers/lookup \\\n    -H \"Authorization: $BLUEHIVE_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bluehive.com/v1/database/health \\\n    -H \"Authorization: $BLUEHIVE_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; createdAt: string; from: string; provider: string; status: 'queued' | 'dialing' | 'sending' | 'delivered' | 'failed' | 'cancelled' | 'retrying'; to: string; estimatedDelivery?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bluehive.com/v1/fax/send \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: $BLUEHIVE_API_KEY\" \\\n    -d '{\n          \"document\": {\n            \"content\": \"content\",\n            \"contentType\": \"application/pdf\"\n          },\n          \"to\": \"to\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bluehive.com/v1/fax/status/$ID \\\n    -H \"Authorization: $BLUEHIVE_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bluehive.com/v1/fax/providers \\\n    -H \"Authorization: $BLUEHIVE_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ _id: string; address: object; email: string; name: string; phones: object[]; createdAt?: string; createdBy?: string; demo?: boolean; employeeConsent?: boolean; onsiteClinic?: boolean; website?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bluehive.com/v1/employers \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: $BLUEHIVE_API_KEY\" \\\n    -d '{\n          \"address\": {\n            \"city\": \"city\",\n            \"state\": \"state\",\n            \"street1\": \"street1\",\n            \"zipCode\": \"zipCode\"\n          },\n          \"email\": \"dev@stainless.com\",\n          \"name\": \"name\",\n          \"phones\": [\n            {\n              \"number\": \"number\"\n            }\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bluehive.com/v1/employers/$EMPLOYER_ID \\\n    -H \"Authorization: $BLUEHIVE_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bluehive.com/v1/employers/list \\\n    -H \"Authorization: $BLUEHIVE_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ _id: string; bundleName: string; employerId: string; serviceIds: string[]; createdAt?: string; createdBy?: string; externallyManaged?: boolean; integration?: string; integrationData?: { enterprise-health?: { addOnServices?: boolean; }; }; limit?: number; occurrence?: string; recurring?: boolean; roles?: string[]; startDate?: string; updatedAt?: string; updatedBy?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bluehive.com/v1/employers/$EMPLOYER_ID/service-bundles \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: $BLUEHIVE_API_KEY\" \\\n    -d '{\n          \"bundleName\": \"x\",\n          \"serviceIds\": [\n            \"string\"\n          ]\n        }'"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bluehive.com/v1/employers/$EMPLOYER_ID/service-bundles/$ID \\\n    -H \"Authorization: $BLUEHIVE_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bluehive.com/v1/hl7/results \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: $BLUEHIVE_API_KEY\" \\\n    -d '{\n          \"employeeId\": \"employeeId\",\n          \"file\": {\n            \"base64\": \"base64\",\n            \"name\": \"name\",\n            \"type\": \"type\"\n          }\n        }'"
      }
    }
  },
  {
    ...
    "description": "Retrieve results for an order. Supports filtering by serviceId, status, date window, and pagination.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bluehive.com/v1/orders/$ORDER_ID/results \\\n    -H \"Authorization: $BLUEHIVE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Create orders for consumers (self-pay or employer-sponsored), employers, or bulk orders. Consolidates functionality from legacy Order.createOrder and Order.SendOrder methods.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bluehive.com/v1/orders \\\n    -X POST \\\n    -H \"Authorization: $BLUEHIVE_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bluehive.com/v1/orders/$ORDER_ID \\\n    -H \"Authorization: $BLUEHIVE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Update order details and associated order items. Allows updating order status, metadata, and modifying order item services.",
    ...
    "response": "{ message: string; orderId: string; orderNumber: string; success: true; updatedFields?: string[]; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bluehive.com/v1/orders/$ORDER_ID/status \\\n    -X PUT \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: $BLUEHIVE_API_KEY\" \\\n    -d '{\n          \"status\": \"order_sent\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Send an order for a specific employee. Requires API key, login token, and user ID. This endpoint specifically handles employer-to-employee order sending.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bluehive.com/v1/orders/send \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: $BLUEHIVE_API_KEY\" \\\n    -d '{\n          \"employeeId\": \"employeeId\",\n          \"employerId\": \"employerId\",\n          \"providersIds\": [\n            {\n              \"providerId\": \"providerId\"\n            }\n          ],\n          \"servicesIds\": [\n            \"string\"\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "description": "Upload test results for a specific order item. Supports both existing fileIds and base64 encoded files. Requires order access code and employee verification.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bluehive.com/v1/orders/$ORDER_ID/upload-results \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: $BLUEHIVE_API_KEY\" \\\n    -d '{\n          \"captchaToken\": \"x\",\n          \"orderAccessCode\": \"x\",\n          \"serviceId\": \"x\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Schedule an appointment or walk-in for an existing order. Sends HL7 SIU^S12 message for appointment booking.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bluehive.com/v1/orders/$ORDER_ID/schedule-appointment \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: $BLUEHIVE_API_KEY\" \\\n    -d '{\n          \"appointment\": {\n            \"date\": \"date\",\n            \"dateTime\": \"2019-12-27T18:11:19.117Z\",\n            \"time\": \"time\"\n          },\n          \"orderAccessCode\": \"orderAccessCode\"\n        }'"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ employees: { _id: string; email: string; employer_id: string; firstName: string; lastName: string; activeAccount?: 'Active' | 'Inactive'; address?: { city: string; postalCode: string; state: string; street1: string; country?: string; county?: string; street2?: string; }; blurb?: string; createdAt?: string; createdBy?: string; departments?: string[]; dob?: string; extendedFields?: { name: string; value: string; }[]; phone?: { number: string; type: 'Cell' | 'Home' | 'Work' | 'Other'; }[]; title?: string; updatedAt?: string; updatedBy?: string; }[]; message: string; success: boolean; total: number; }",
  ...
  },
  {
    ...
    "response": "{ employee: { _id: string; email: string; employer_id: string; firstName: string; lastName: string; activeAccount?: 'Active' | 'Inactive'; address?: { city: string; postalCode: string; state: string; street1: string; country?: string; county?: string; street2?: string; }; blurb?: string; createdAt?: string; createdBy?: string; departments?: string[]; dob?: string; extendedFields?: { name: string; value: string; }[]; phone?: { number: string; type: 'Cell' | 'Home' | 'Work' | 'Other'; }[]; title?: string; updatedAt?: string; updatedBy?: string; }; message: string; success: boolean; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bluehive.com/v1/employees/$EMPLOYEE_ID \\\n    -H \"Authorization: $BLUEHIVE_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bluehive.com/v1/employees/link-user \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: $BLUEHIVE_API_KEY\" \\\n    -d '{\n          \"employeeId\": \"x\",\n          \"userId\": \"x\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bluehive.com/v1/employees/unlink-user \\\n    -X DELETE \\\n    -H \"Authorization: $BLUEHIVE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Returns the current brand integrations object keyed by integration name (empty object if none). Brand resolved via x-brand-id header.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bluehive.com/v1/integrations \\\n    -H \"Authorization: $BLUEHIVE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Returns true if the named integration is active for the given brand (brand resolved via x-brand-id header).",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.bluehive.com/v1/integrations/$NAME \\\n    -H \"Authorization: $BLUEHIVE_API_KEY\""
      }
    }
  }
];
