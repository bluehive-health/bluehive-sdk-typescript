...
export const parseClientAuthHeaders = (req: IncomingMessage, required?: boolean): Partial<ClientOptions> => { const apiKey = Array.isArray(req.headers['x-blue-hive-api-key']) ? req.headers['x-blue-hive-api-key'][0] : req.headers['x-blue-hive-api-key']
return {apiKey}; }
