...
export const metadata: Metadata = {
  ...
  operationId: 'getEmployerServiceBundle',
};

export const tool: Tool = {
  name: 'retrieve_employers_service_bundles',
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\nGet Service Bundle\n\n# Response Schema\n```json\n{\n  $ref: '#/$defs/service_bundle_retrieve_response',\n  $defs: {\n    service_bundle_retrieve_response: {\n      type: 'object',\n      properties: {\n        _id: {\n          type: 'string'\n        },\n        bundleName: {\n          type: 'string'\n        },\n        employerId: {\n          type: 'string'\n        },\n        serviceIds: {\n          type: 'array',\n          items: {\n            type: 'string'\n          }\n        },\n        createdAt: {\n          type: 'string'\n        },\n        createdBy: {\n          type: 'string'\n        },\n        roles: {\n          type: 'array',\n          items: {\n            type: 'string'\n          }\n        },\n        updatedAt: {\n          type: 'string'\n        },\n        updatedBy: {\n          type: 'string'\n        }\n      },\n      required: [        '_id',\n        'bundleName',\n        'employerId',\n        'serviceIds'\n      ]\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
      employerId: {
...
export const handler = async (client: BlueHive, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.employers.serviceBundles.retrieve(id, body)),
  );
};
