...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      offset: {
        type: 'string',
        description: 'Number of employees to skip (default: 0)',
      },
      jq_filter: {
        type: 'string',
        title: 'jq Filter',
...
export const handler = async (client: BlueHive, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.employees.list(body)));
};
