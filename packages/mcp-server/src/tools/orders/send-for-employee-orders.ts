...
export const tool: Tool = {
  ...
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\nSend an order for a specific employee. Requires API key, login token, and user ID. This endpoint specifically handles employer-to-employee order sending.\n\n# Response Schema\n```json\n{\n  $ref: '#/$defs/order_send_for_employee_response',\n  $defs: {\n    order_send_for_employee_response: {\n      anyOf: [        {\n          type: 'object',\n          properties: {\n            orderId: {\n              type: 'string'\n            },\n            orderNumber: {\n              type: 'string'\n            },\n            success: {\n              type: 'string',\n              enum: [                true\n              ]\n            },\n            message: {\n              type: 'string'\n            },\n            partialSuccess: {\n              type: 'boolean',\n              description: 'True when some services were unavailable but order was still created'\n            },\n            unavailableServices: {\n              type: 'array',\n              description: 'Services that could not be included in the order',\n              items: {\n                type: 'object',\n                properties: {\n                  reason: {\n                    type: 'string',\n                    description: 'Why the service was unavailable'\n                  },\n                  serviceId: {\n                    type: 'string'\n                  },\n                  serviceName: {\n                    type: 'string'\n                  }\n                },\n                required: [                  'reason',\n                  'serviceId'\n                ]\n              }\n            }\n          },\n          required: [            'orderId',\n            'orderNumber',\n            'success'\n          ]\n        },\n        {\n          type: 'object',\n          properties: {\n            orderResults: {\n              type: 'array',\n              items: {\n                type: 'object',\n                properties: {\n                  orderId: {\n                    type: 'string'\n                  },\n                  orderNumber: {\n                    type: 'string'\n                  },\n                  providerId: {\n                    type: 'string'\n                  }\n                },\n                required: [                  'orderId',\n                  'orderNumber',\n                  'providerId'\n                ]\n              }\n            },\n            status: {\n              type: 'string',\n              enum: [                'split'\n              ]\n            },\n            success: {\n              type: 'string',\n              enum: [                true\n              ]\n            },\n            message: {\n              type: 'string'\n            },\n            partialSuccess: {\n              type: 'boolean',\n              description: 'True when some services were unavailable but orders were still created'\n            },\n            unavailableServices: {\n              type: 'array',\n              description: 'Services that could not be included in any order',\n              items: {\n                type: 'object',\n                properties: {\n                  reason: {\n                    type: 'string',\n                    description: 'Why the service was unavailable'\n                  },\n                  serviceId: {\n                    type: 'string'\n                  },\n                  serviceName: {\n                    type: 'string'\n                  }\n                },\n                required: [                  'reason',\n                  'serviceId'\n                ]\n              }\n            }\n          },\n          required: [            'orderResults',\n            'status',\n            'success'\n          ]\n        }\n      ],\n      description: 'Order sent successfully (single or split)'\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
      employeeId: {
